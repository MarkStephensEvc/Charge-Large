...
colour_mix = 0.3
# variable labels
var_labels = {"cpo_name":"Charge point operator",
...
centroids = {'NSW': (-32.18411400724141, 147.03133362435045),
            ...
            'WA': (-24.72876512035109, 122.58780493871897),
            'SWWA': (-32.72515110600491, 117.53822006487553),
...
utilisation_status = {
     "in_use":"In Use or Occupied",
     "Available":"Available for Use",
     "unavailable_out_of_order":"Unavailable or Out of Order"
     }
